...
def make_vote_based_scatter_plot(names, data, x, y, hue, kind, remark=''):
    if remark:
        remark = '-' + remark
    ...
    plt.savefig(f'../plots/vote-based-scatter-plot-simple{remark}2.png')
    plt.close()
    ...
    plt.savefig(f'../plots/vote-based-scatter-plot-joint{remark}2.png')
    plt.close()


def make_voter_based_scatter_plot(policies, data, x, y, remark=''):
    if remark:
        remark = '-' + remark
    ...
    plt.savefig(f'../plots/voter-based-scatter-plot-for-policies{remark}2.png')
    plt.close()


def plot_politician_embeddings(politicians_of_interest, plot_umap=True):
    """Produce scatter plot of politicians"""
    ...
    # Plot
    make_vote_based_scatter_plot(
        politicians_of_interest,
        data=voting_records_2d,
        x='Component 1',
        y='Component 2',
        hue=parties,
        kind='scatter',
...
def plot_policy_embeddings(policies_of_interest, plot_umap=True):
    """Produce scatter plot of policies"""
...
def main():
    ...
    plot_politician_embeddings(politicians_of_interest)
    # plot_policy_embeddings(policies_of_interest)
